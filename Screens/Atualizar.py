...
class Atualizar(tkinter.Frame):
  ...
  def consultar_dados(self):
    ...
    if self.lista:
      self.master.tela8.recuperar_lista(self.lista)
      self.master.mostrar_tela(self.master.tela8)
    else:
