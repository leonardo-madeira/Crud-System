...
class Consultar(tkinter.Frame):
  def __init__(self, master):
    ...
    texto1 = Label(self, text="Digite o nome, cpf, telefone, email ou \nendereço para consultar o cadastro.",
  ...
  def consultar_dados(self):
    ...
    if self.lista:
      self.master.tela6.exibir_dados(self.lista)
      self.master.mostrar_tela(self.master.tela6)
    else:
